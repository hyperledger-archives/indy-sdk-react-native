...
3. Download the required libindy binaries for your release-channel and version
   - with `stable` channel and version `1.14.3` base url will be https://repo.sovrin.org/android/libindy/stable/1.14.3/
   - download the binaries for `arm64`, `armv7`, `x86` and `x86_64`, e.g.:
     - `libindy_android_arm64_1.14.3.zip`
     - `libindy_android_armv7_1.14.3.zip`
     - `libindy_android_x86_1.14.3.zip`
     - `libindy_android_x86_64_1.14.3.zip`
...
5. Download the required JNA binaries from the [JNA GitHub repo](https://github.com/java-native-access/jna)
   - libindy version 1.14.3 works with version 5.2.0 of JNA. In this case the base url is: https://github.com/java-native-access/jna/tree/5.2.0/lib/native
